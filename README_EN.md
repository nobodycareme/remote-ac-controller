...
> **Status:** v1.0.0 — initial public open-source release.
...
├─ docs/         # Architecture, hardware, IR, MQTT, security, ops (12 documents)
...
- Self-hosters must provision their own MQTT credentials, TLS certificates,
  and IR codes.
- See [`docs/security-model.md`](./docs/security-model.md) for the threat
  model and [`docs/deployment.md`](./docs/deployment.md) for hardening.
...
| Host | 1 GB RAM is workable if you build off-host — see [`docs/resource-constrained-deployment.md`](./docs/resource-constrained-deployment.md) |

## Documentation

[`docs/`](./docs) — twelve documents, grouped by what you are trying to do:

| Getting it working | Understanding it | Running it |
|---|---|---|
| [`hardware.md`](./docs/hardware.md) | [`architecture.md`](./docs/architecture.md) | [`deployment.md`](./docs/deployment.md) |
| [`wiring.md`](./docs/wiring.md) | [`mqtt-protocol.md`](./docs/mqtt-protocol.md) | [`operations-guide.md`](./docs/operations-guide.md) |
| [`ir-learning.md`](./docs/ir-learning.md) | [`security-model.md`](./docs/security-model.md) | [`resource-constrained-deployment.md`](./docs/resource-constrained-deployment.md) |
| | [`scheduling.md`](./docs/scheduling.md) · [`temperature-automation.md`](./docs/temperature-automation.md) | [`troubleshooting.md`](./docs/troubleshooting.md) |

## Contributing

See [`CONTRIBUTING.md`](./CONTRIBUTING.md). Contributions are licensed under
Apache-2.0.

## License

[Apache License 2.0](./LICENSE). Third-party licenses are aggregated in
