...
Full guide: [Arduino IDE 使用指南 (zh)](./docs/中文/Arduino-IDE使用指南.md)
...
[红外学习 (zh)](./docs/中文/红外学习.md) — tool in
...
[西电校园网自动认证 (zh)](./docs/中文/西电校园网自动认证.md) and
[Srun 移植指南 (zh)](./docs/中文/Srun校园网移植指南.md).
...
[西电校园网自动认证 (zh)](./docs/中文/西电校园网自动认证.md).
...
[参与贡献指南 (zh)](./docs/中文/参与贡献.md) first.
