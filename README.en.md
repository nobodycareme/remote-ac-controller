...
| Wiring guide | [`docs/English/wiring.md`](docs/English/wiring.md) |
| Hardware guide | [`docs/English/hardware.md`](docs/English/hardware.md) |
...
| IR learning workflow | [`docs/English/ir-learning.md`](docs/English/ir-learning.md) |
...
- Real IR emission is protected by multiple independent kill switches, all
  defaulting to off.
- See [`SECURITY.md`](docs/English/security.md) for the security policy.
...
[English documentation index](docs/English/documentation-index.md) or the
[中文文档导航](docs/English/documentation-index.md).

| Getting Started | Understanding | Operations |
|---|---|---|
| [Architecture](docs/English/architecture.md) | [MQTT Protocol](docs/English/mqtt-protocol.md) | [Deployment](docs/English/deployment.md) |
| [Hardware](docs/English/hardware.md) | [Security Model](docs/English/security-model.md) | [Ops Guide](docs/English/operations-guide.md) |
| [Wiring](docs/English/wiring.md) | [Scheduling](docs/English/scheduling.md) | [Troubleshooting](docs/English/troubleshooting.md) |
| [IR Learning](docs/English/ir-learning.md) | [Temp Automation](docs/English/temperature-automation.md) | [Backup & Recovery](docs/English/backup-and-recovery.md) |
| [Arduino IDE Guide](docs/English/arduino-ide-guide.md) | [Xidian Campus Auth](docs/English/xidian-campus-network-authentication.md) | [Resource-Constrained Deployment](docs/English/resource-constrained-deployment.md) |
| [Contributing](docs/English/contributing.md) | [Srun Porting Guide](docs/English/srun-campus-network-porting-guide.md) | [Support](docs/English/support.md) |
