...
See [`temperature-automation.md`](./temperature-automation_EN.md) §10 — no amount
...
| Insufficient supply current | Works close, fails at distance — see [`hardware.md`](./hardware_EN.md) §4 |
...
[`deployment.md`](./deployment_EN.md) §8. REST works, live updates do not, which
...
| `REAL_IR_DISABLED` | Kill switch off | See [`security-model.md`](./security-model_EN.md) §5 |
...
[`mqtt-protocol.md`](./mqtt-protocol_EN.md) §5.
