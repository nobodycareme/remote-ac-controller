...
- Hardware assembled and verified per [`wiring.md`](./wiring.md).
...
are not crossed — see [`wiring.md`](./wiring.md) §1.
...
[`security-model.md`](./security-model.md) §5. In summary:
...
| Replay works at 10 cm but not 3 m | Insufficient supply current — see [`hardware.md`](./hardware.md) §4 |
