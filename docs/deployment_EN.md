...
Read [`security-model.md`](./security-model_EN.md) first. Deploying this with
...
|-----------|-------------|
| Server | Linux, 1 vCPU / 1 GB RAM minimum (see [`resource-constrained-deployment.md`](./resource-constrained-deployment_EN.md)) |
...
> [`troubleshooting.md`](./troubleshooting_EN.md).
