**简体中文** | [English](../English/code-of-conduct.md)

# 贡献者公约行为准则

> 本文件是 [Contributor Covenant](https://www.contributor-covenant.org) **2.1 版**的中文版本，与英文原文 [code-of-conduct.md](../English/code-of-conduct.md) 内容一致。如中英文表述存在差异，以英文原文为准。归属信息见文末「归属」一节，不得删减。
