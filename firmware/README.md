...
[![PlatformIO](https://img.shields.io/badge/PlatformIO-espressif8266-orange.svg)](https://platformio.org/)

Mobile remote AC control firmware for NodeMCU ESP8266 (ESP-12E). Runtime diagnostics, campus network auth, MQTT cloud foundation.

> **Sister repo** — cloud backend + frontend: [remote-ac-cloud](https://github.com/nobodycareme/remote-ac-controller)
...
| Framework | Arduino |
| Build entry | 	ools\dev.ps1 (ONLY supported entry) |
...
| Campus network auth (Xidian Srun v2, TLS SHA-1 pin) | ✅ Verified |
...
| MQTT cloud connection | ✅ Verified |
...
All builds MUST use 	ools\dev.ps1:
