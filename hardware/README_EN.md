...
| Document | Covers |
|---|---|
| [`docs/hardware.md`](../docs/hardware_EN.md) | Bill of materials, module selection, GPIO constraints, power budget, memory limits |
| [`docs/wiring.md`](../docs/wiring_EN.md) | Pin-by-pin wiring, the DHT11 and IR module connections, verification steps |
| [`docs/ir-learning.md`](../docs/ir-learning_EN.md) | Capturing and registering your air conditioner's IR frames |
| [`docs/troubleshooting.md`](../docs/troubleshooting_EN.md) | Sensor, IR and connectivity fault tables |
...
2. **Automation can command a real appliance.** Real IR transmission is
   ...
   [`docs/security-model.md`](../docs/security-model_EN.md)). Enable it only once
